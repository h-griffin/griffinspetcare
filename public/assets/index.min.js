...
const months=document.getElementById('month');months.addEventListener('change',function(){const id=months.value;if(id){contents.forEach(content=>{content.classList.remove("active")});const element=document.getElementById(id);element.classList.add("active")}})